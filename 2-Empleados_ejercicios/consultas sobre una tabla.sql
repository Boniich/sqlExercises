...
-- 23- Devuelve una lista con el nombre de los departamentos y el presupuesto, 
...
select nombre, apellido1, apellido2, nif from empleado where id_departamento = (select id from departamento where id = 3);

-- 36- Lista los nombres, apellidos y nif de los empleados que trabajan en los departamentos 2, 4 o 5 

select nombre,apellido1,apellido2, nif from empleado where id_departamento IN
(select id from departamento where id in(2,4,5));